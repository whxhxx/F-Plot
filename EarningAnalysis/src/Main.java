...
//		System.out.println(getInfo("yoku"));
	...
	//	System.out.println(getInfoWithNextDay("yoku"));
		 ...
		 //以下为使用静态方法的计算
		List<List<String>> list1 = getInfoWithNextDay("msft");   //更改TICKER的地方
...
//			System.out.println("当前Suprise" + list1.get(i).get(4));
		...
		System.out.print("allN + : ");
		System.out.println( new DecimalFormat("##").format(allN));
		System.out.print("Suprise + : ");
		System.out.println(n_sUP +" - %" + new DecimalFormat("##.##").format(n_sUP*100/allN));
		System.out.print("Suprise =0: ");
		System.out.println(n_sMatch+ " - %" + new DecimalFormat("##.##").format(n_sMatch*100/allN));
		System.out.print("Suprise - : ");
		System.out.println(n_sDOWN +" - %" + new DecimalFormat("##.##").format(n_sDOWN*100/allN));
		System.out.println();
		...
		System.out.println(n_pUP +" - %"+ new DecimalFormat("##.##").format(n_pUP*100/allN));
		System.out.print("Price - : ");
		System.out.println(n_pDOWN +" - %"+ new DecimalFormat("##.##").format(n_pDOWN*100/allN));
		System.out.println();
		//2end
		...
		System.out.println(n_sUPpUP+" - %"+ new DecimalFormat("##.##").format(n_sUPpUP*100/allN) );
		System.out.print("Suprise+ Price- : ");
		System.out.println(n_sUPpDOWN+" - %"+ new DecimalFormat("##.##").format(n_sUPpDOWN*100/allN));
		System.out.print("Suprise- Price+ : ");
		System.out.println(n_sDOWNpUP+" - %"+ new DecimalFormat("##.##").format(n_sDOWNpUP*100/allN));
		System.out.print("Suprise- Price- : ");
		System.out.println(n_sDOWNpDOWN+" - %"+ new DecimalFormat("##.##").format(n_sDOWNpDOWN*100/allN));
		System.out.println();
		//3end
